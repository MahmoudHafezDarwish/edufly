...
import '../../../custom_widgets/widgets/userGrid.dart';
...
class _EnrolledUserState extends State<EnrolledUser> {
  ...
  late List<UserProfile> users = [UserProfile(name: 'mahmoud',gmail: 'gmail',uid: '',enrolledCourse: [],profile_picture: '',parentId: '',createdCourse: [])];
