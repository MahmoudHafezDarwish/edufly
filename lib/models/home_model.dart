class HomeModel {
  HomeModel({
    ...
    required this.sliderfacts,
    required this.trusted,
    required this.testimonial,
    required this.category,
    required this.subcategory,
    required this.childcategory,
    required this.featuredCate,
  });
...
class Settings {
  Settings({
    ...
    required this.cpyTxt,
    required this.logoType,
    this.rightclick,
    this.inspect,
    required this.metaDataDesc,
    required this.metaDataKeyword,
    required this.googleAna,
    required this.fbPixel,
    this.fbLoginEnable,
